    ...
    <div className="max-w-4xl mx-auto p-8 bg-white shadow-lg rounded-lg">
      ...
      <section className="mb-8">
        <p className="mb-4 text-lg text-gray-700 leading-relaxed">
          この利用規約（以下，「本規約」といいます。）は，雪櫻（以下，「開発者」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="mb-4 text-gray-700 leading-relaxed">
          ユーザーは，本サービスの有料部分の対価として，開発者が別途定め，本ウェブサイトに表示する利用料金を，開発者が指定する方法により支払うものとします。
      ...
      <section className="mb-8">
        ...
        <p className="text-right text-gray-600 font-medium">以上</p>
      </section>
    </div>
  );
}
